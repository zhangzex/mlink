...
pool := slab.NewAtomPool(
	64,          // The smallest chunk size is 64B. 最小的块大小是64B
	64 * 1024,   // The largest chunk size is 64KB. 最大的块大小是64B
	2,           // Power of 2 growth in chunk size. 2个块之间曾长的大小是块的大小
	1024 * 1024, // Each slab will be 1MB in size. 每个承载块的(slab)平板的大小是 1 M.
)
